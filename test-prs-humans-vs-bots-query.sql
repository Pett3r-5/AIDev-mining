...
-- verifica que pc1 tenha sido criado em uma PR posterior ao fechamento da PR de pc2
-- WITH r_test AS (
  ...
  WHERE
    ...
    AND pr1.created_at > pr2.merged_at
    AND (
...
-- SELECT
--   DISTINCT (t1.pr_id), t1.*, t2.*
-- FROM r_test t1
--   INNER JOIN pull_request t2
--     ON t1.pr_id = t2.id
